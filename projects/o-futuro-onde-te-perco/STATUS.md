...
- novas propostas narrativas/canônicas/estruturais são apresentadas no chat antes de consolidação;
- brainstorm não vira decisão aprovada silenciosamente;
- blocos estruturais relevantes usam branch + PR;
- o assistente revisa o PR, executa/lê a auditoria, corrige problemas e realiza o merge quando a mudança aprovada estiver consistente;
...
- contexto exato do pedido de desculpas;
