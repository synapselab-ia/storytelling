...
> Este arquivo é a zona segura de brainstorm. Nada aqui vira canon ou estrutura aprovada sem decisão explícita do usuário e consolidação no arquivo correspondente.

## Blocos já consolidados

### Sobrenatural e sonhos
...
Marcos aprovados incluem:

- implicância real antes do acidente, sem paixão juvenil secreta;
- reconhecimento de Lívia como mulher dos sonhos em aproximadamente 25–30%;
- Lívia descobre os sonhos em aproximadamente 35–40%;
- pacto explícito contra Henrique usar Tomás/família/terceiros para administrar as escolhas dela;
- pedido de desculpas pelo hospital antes da revelação completa do acidente;
- primeiro beijo aproximadamente em 45–50%;
- relação assumida aproximadamente em 50–60%, antes da residência;
- ruptura pela violação do pacto ao envolver Tomás;
- reparação de Henrique começa com contenção e correção da narrativa familiar;
- reconciliação exige mudança de comportamento sob medo real;
...
- **pessoa:** terceira pessoa limitada;
- **tempo verbal:** passado;
- **distância:** próxima, com variação controlada;
- não haverá POV principal de Lívia ou Tomás;
- a ausência de POV de Lívia não autoriza reduzir sua agência nem substituir o que ela comunica por interpretações de Henrique;
- sonhos permanecem em terceira pessoa limitada de Henrique e no passado, com distância mais próxima e linguagem mais sensorial/fragmentária;
...
O uso de páginas pretas para sonhos está aprovado como direção visual, mas ainda não estão definidos:

- cor e tratamento tipográfico do texto;
- margens, ornamentos e sangria;
- regra de página par/ímpar;
- comportamento no e-book;
- solução de acessibilidade e impressão sem cor/fundo integral.

Esses itens pertencem à etapa editorial/diagramação e não devem atrasar o outline narrativo.
