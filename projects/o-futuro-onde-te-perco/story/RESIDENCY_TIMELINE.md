# Linha temporal da residência coreográfica
...
- ela ainda não foi selecionada;
- não existe confirmação de viagem;
- o envio torna a linha futura causalmente alcançável;
- o primeiro sonho relevante de Henrique ocorre na mesma noite ou imediatamente em torno desse evento.
...
A reação inicial de Henrique à notícia deve incluir felicidade genuína pela conquista profissional dela.
...
Nunca fundir estes eventos em um único marco:

**candidatura (Ato 1) → seleção/aceite (Ato 3) → viagem/início físico (fim do Ato 3 / Ato 4).**

A candidatura abre a trajetória possível; a seleção confirma a oportunidade; a viagem inicia a experiência profissional concreta.
